...
from tensorflow.keras.layers import Dense, Dropout, Conv2D, LSTM, Flatten, MaxPooling2D, BatchNormalization
...
def getModel(cloud_dim, precipitation_dim, wind_dim, humidity_dim, pressure_dim, temperature_dim,
    ...
    x1 = MaxPooling2D(pool_size=(1, 2))(
        Conv2D(16, kernel_size=(1, 2), padding='same', activation=relu)(BatchNormalization()(x1))) if x1 is not None else None
